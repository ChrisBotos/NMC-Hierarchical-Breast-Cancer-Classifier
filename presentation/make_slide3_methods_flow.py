...
def main():
    ...
    label_box(
        ax, her2_x, her2_y - her2_h / 2, her2_w, her2_h, "HER2+", C["HER2"], fs=12
    )
    txt(
        ax,
        her2_x - 0.07,
    ...
    for i, (col, lab) in enumerate(
        ...
        box(ax, cdot_x, cdot_y - 0.01, cdot_w, 0.02, col, C["border"], lw=0.6, zorder=4)
        txt(
            ax,
            cdot_x + cdot_w + 0.01,
            cdot_y,
    ...
    txt(ax, x5 + w5 / 2, y5 - 0.14, "48/57 correct (~84.2%)", fontsize=9, color="white")
