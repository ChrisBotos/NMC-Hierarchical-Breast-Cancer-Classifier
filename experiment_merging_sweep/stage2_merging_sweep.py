"""Quick temp experiment: Stage 2 (HR+ vs TN) KW+NMC across different
...
Usage:
    python3 temp_merging_sweep/stage2_merging_sweep.py
"""
...
def main():
    ...
    for label, (scores, best_ks) in results.items():
        ...
        print(f"{label:<18} {scores.mean():<12.4f} {scores.std():<10.4f} "
    ...
    ref_label = [l for l in labels if "r=0.8" in l][0]
